...
class AssetVideoScrollView: UIScrollView {
    ...
    private func setupSubviews() {
        ...
        _widthConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 1.0)
    ...
    private func setContentSize(for asset: AVAsset) -> CGSize {
        ...
        _widthConstraint = contentView.widthAnchor.constraint(equalTo: widthAnchor, multiplier: contentWidthFactor)
        _widthConstraint?.isActive = true
        layoutIfNeeded()
